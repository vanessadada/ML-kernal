...
int main(void) {
    ...
    // RUN_TEST(test_matmul_square_matrices_1000);

    // RUN_TEST(test_optimal_matmul_square_matrices_10);
    // RUN_TEST(test_optimal_matmul_square_matrices_100);
    // RUN_TEST(test_optimal_matmul_square_matrices_500);
    RUN_TEST(test_optimal_matmul_square_matrices_1000);
