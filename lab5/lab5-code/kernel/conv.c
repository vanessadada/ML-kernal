...
float ***convolution_im2col(float ***image, int numChannels, float ****kernel, float *biasData, int numFilters, int inputSize, int kernelSize)
{
    ...
    // float **matmul_output = matmul_multithread(flattened_kernel, im2col_output, numFilters, kernelSize * kernelSize, kernelSize * kernelSize, outputSize);
    // float **matmul_output = matmul_blocking(flattened_kernel, im2col_output, numFilters, kernelSize * kernelSize, kernelSize * kernelSize, outputSize);
